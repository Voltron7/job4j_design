...
class ControlQualityTest {
    ...
    public void whenDistributeToStores() {
        ...
        assertThat(trash.get().get(0)).isEqualTo(bread);
        assertThat(warehouse.get().get(0)).isEqualTo(cheese);
        assertThat(shop.get().get(0)).isEqualTo(butter);
    }
    ...
    public void whenShopWithDiscount() {
        ...
        assertThat(shop.get().get(0).getPrice()).isEqualTo(butter1.getPrice());
    }
    ...
    public void whenShopWithoutDiscount() {
        Food butter = new Butter("Butter", LocalDate.now().plusMonths(3), LocalDate.now().minusMonths(3),
                150.00f, 20.0f);
        cq.distribute(butter);
        assertThat(shop.get().get(0).getPrice()).isEqualTo(butter.getPrice());
    }
}